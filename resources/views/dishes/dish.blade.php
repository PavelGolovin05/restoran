...
<div id="pm_layout_wrapper" class="pm-full-mode"><!-- Use wrapper for wide or boxed mode -->
    ...
    <div class="container pm-containerPadding80">
        ...
        <div class="dish-item">
            <img src="{{ $dish->photo_link }}" alt="" style="max-width: 400px;max-height: 400px;">
        </div>
        ...
        <div class="dish-item">
            ...
            <p>Вес: {{$dish->weight}}{{$dish->measure}}</p>
            ...
            <p>
                @if(count($ingredients) > 0)
                    ...
                    @endforeach
                @endif
            @if($dish->is_stop_list == 1)
                <p style="color: #761b18 ">В стоп-листе</p>
                @endif
            </p>
