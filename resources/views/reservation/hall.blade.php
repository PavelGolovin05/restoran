    ...
    <div id="pm_layout_wrapper" class="pm-full-mode"><!-- Use wrapper for wide or boxed mode -->
        ...
        <div class="container pm-containerPadding80">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 pm-column-spacing">
                ...
                <form action="{{ url('reservations/addReservation/') }}">
                    <table>
                        <tr>
                            <div class="dish-item">
                                <p>
                                Зал: {{$hall->id}} {{ $hall->hall_type->name}}
                                </p>
                            </div>
                        ...
                        <tr>
                            <td>Время заказа: {{$date}}</td>
                        </tr>
                        <tr>
                            <td>Выберете свободный столик:</td>
                            <td>
                                <select name="table_id">
                                    @foreach($tables as $table)
                                        <option value="{{ $table->id }}">Столик № {{ $table->table_num }}</option>
                                    @endforeach
                                </select>
                            </td>
                        </tr>
