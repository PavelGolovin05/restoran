...
<div id="pm_layout_wrapper" class="pm-full-mode">
    ...
    <div class="pm-sub-header-container pm-parallax-panel" data-stellar-background-ratio="0.5" data-stellar-vertical-offset="0">
        ...
        <div class="pm-sub-header-title-container">
            <p class="pm-sub-header-title"><span>Бронирование</span></p>
    ...
    <div class="container pm-containerPadding80">
        <div class="col-lg-4 col-md-4 col-sm-6 pm-column-spacing">
                <form action="{{ url('reservations/hall/') }}">
                    <select name="hall_id">
                        <br>
                        <br>
                    ...
                    <br>
                    <br>
                    <td>Время заказа: <input required type="datetime-local" id="localdate" name="date"></td>
                    <br>
                    <br>
                    <input type="submit" value="Показать свободные столики">
                </form>
            <br>
            <br>
            <form action="{{ url('reservations/myReservations/') }}">
                <input type="submit" value="Посмотреть мои бронирования">
            </form>
