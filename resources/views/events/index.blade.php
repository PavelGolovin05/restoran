...
<div id="pm_layout_wrapper" class="pm-full-mode">
    ...
    <div class="pm-sub-header-container pm-parallax-panel" data-stellar-background-ratio="0.5" data-stellar-vertical-offset="0">
        ...
        <div class="pm-sub-header-title-container">
            <p class="pm-sub-header-title"><span>Мероприятие</span></p>
    ...
    <div class="container pm-containerPadding80">
        <div class="col-lg-4 col-md-4 col-sm-6 pm-column-spacing">
            <form action="{{ url('events/addEvent/') }}">

                <select name="hall_id" onchange="">
                    <br>
                    <br>
                    <option value="0">Зал</option>
                    @foreach ($halls as $hall): ?>
                    <option value="{{ $hall->id }}">{{ $hall->id }} {{ $hall->hall_type->name }}</option>
                    @endforeach
                </select>
                <br>
                <br>
                <select name="event_type">
                    <option value="0">Тип мероприятия</option>
                ...
                <br>
                <br>
                <td>Дата мероприятия: <input required type="datetime-local" id="localdate" name="date"></td>
                <br>
                <br>
                <td>Количество людей: <input required type="text" name="count"></td>
                <br>
                <br>
            ...
            <form action="{{ url('events/myEvents/') }}">
                <input type="submit" value="Посмотреть мои мероприятия">
            </form>
