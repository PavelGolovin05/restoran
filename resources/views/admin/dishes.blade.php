...
<div id="pm_layout_wrapper" class="pm-full-mode"><!-- Use wrapper for wide or boxed mode -->
    ...
    <div class="container pm-containerPadding80">
        <br>
        <br>
        <a href="{{ url('admin/addDishForm') }}">Добавить блюдо</a>
        <br>
        <br>
        <a href="{{ url('admin/removeDishForm') }}">Добавить блюдо в стоп-лист</a>
        <br>
        <br>
        <a href="{{ url('admin/removeDishFromStopForm') }}">Убрать из стоп-листа</a>
    </div>
</div>
